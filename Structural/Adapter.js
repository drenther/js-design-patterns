/*
	...
	This pattern is often used to create wrappers for new refactored APIs so that other exisiting old APIs can still work with them.
*/
...
const newCalc = new NewCalculator();
console.log(newCalc.add(10, 5, 'add')); // 15
